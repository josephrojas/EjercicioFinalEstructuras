...
class CityDescription extends StatefulWidget {
  ...
  CityDescription({Key key, @required this.cityId});
  @override
  ...
  void getValue() {
    setState(() {
      switch (widget.cityId[_actualPosition+1]) {
        ...
        case 1: //Oviedo city
          _cityDescription =
              "Oviedo is a town in northwest Spain between the Cantabrian Mountains and the Bay of Biscay. The capital of Asturias, it’s known for its medieval old town, the site of the Gothic Oviedo Cathedral with its 9th-century Holy Chamber. "
        ...
        case 2: //Bilbao City
          _cityDescription =
              "Bilbao, an industrial port city in northern Spain, is surrounded by green mountains. It’s the de facto capital of Basque Country, with a skyscraper-filled downtown. "
        ...
        case 5: //Alicante city
          _cityDescription =
              "Alicante is a port city on Spain’s southeastern Costa Blanca, and the capital of the Alicante province. Its old town, Barrio de la Santa Cruz, has narrow streets, colored houses and a nightlife scene."
        ...
        default:
          _cityDescription = "No existe esta ciudad";
          _cityValue = "0";
          _cityName = "No existe esta ciudad";
          _pathImage = "assets/img/sevilla.jpg";
          break;
      }
    });
                  ...
                  Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover, image: AssetImage(_pathImage)),
